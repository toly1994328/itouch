...
/// quick succession.
///
/// [TwoTapGestureRecognizer] competes on pointer events of [kPrimaryButton]
/// only when it has a non-null callback. If it has no callbacks, it is a no-op.
///
class TwoTapGestureRecognizer extends GestureRecognizer {
  ...
  void acceptGesture(int pointer) {
    ...
    if(isChecked){
      ...
      final TapDownDetails details = TapDownDetails(
        globalPosition: _down.position,
        localPosition: _down.localPosition,
        kind: getKindForPointer(_down.pointer),
      );
